...
I have set up this Dapp as an Angular.js application with the intention of using the rich set of components available via Sencha and their Ext.js Packages.
